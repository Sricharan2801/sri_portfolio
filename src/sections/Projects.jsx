    ...
    return (
        <section className='c-space my-20' id='work'>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 mt-10 gap-5 w-full ' >
                ...
                <div className='flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadoow-2xl 
                shadow-black-200'>
                    ...
                    <div className='flex flex-col gap-5 text-white-600 my-5'>
                        <p className='text-white text-2xl font-semibold animated'>{currentProject.title} </p>
                        ...
                        <Center>
                            <Suspense fallback={<CanvasLoader />}>
                                <group scale={2} position={[0, -3, 0]} rotation={[0, -0.1, 0]}>
                                    <DemoComputer text={currentProject.texture} />
                                </group>
                            </Suspense>
                        </Center>
